...
//	} STRU_TELE_GPS_STAT;
	...
	private void decode(final byte[] rawData) {
		speedInKnots = Short.parseShort(StringHelper.bcdEncodeInverted(rawData, 6, 2));
		UTC = Integer.parseInt(StringHelper.bcdEncodeInverted(rawData, 8, 4));
		numSats = Byte.parseByte(StringHelper.bcdEncodeInverted(rawData, 12, 1));
		altitudeHightInMeter = Short.parseShort(StringHelper.bcdEncodeInverted(rawData, 13, 1));
