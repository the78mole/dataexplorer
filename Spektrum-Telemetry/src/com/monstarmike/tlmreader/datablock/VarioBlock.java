...
//	} STRU_TELE_VARIO_S;
	...
	private void decode(byte[] rawData) {
		...
		deltaInIntervalOf2000MsInTenthOfMeter = Shorts.fromBytes(rawData[16], rawData[17]);
		deltaInIntervalOf3000MsInTenthOfMeter = Shorts.fromBytes(rawData[18], rawData[19]);
