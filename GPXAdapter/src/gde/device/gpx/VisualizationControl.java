...
public class VisualizationControl extends Composite {
	...
	public VisualizationControl(Composite parentComposite, FormData useLayoutData, GPXAdapterDialog parentDialog, int useChannelConfigNumber, IDevice useDevice, String useName,
	...
	void create() {
		{
			if (this.typeName.equals(Messages.getString(MessageIds.GDE_MSGT1785))) {
