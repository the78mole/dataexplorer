...
//			property = record.getProperty(LiPoWatch.CURRENT_OFFSET);
...
//			property = record.getProperty(LiPoWatch.RPM_FACTOR);
//			double rpmFactor = property != null ? new Double(property.getValue()).doubleValue() : 1.0;
//			property = record.getProperty(LiPoWatch.NUMBER_MOTOR);
...
//			PropertyType property = record.getProperty(LiPoWatch.NUMBER_CELLS);
...
//			property = recordRevolution.getProperty(LiPoWatch.RPM_FACTOR);
//			double rpmFactor = property != null ? new Double(property.getValue()).doubleValue() : 1.0;
//			property = recordRevolution.getProperty(LiPoWatch.NUMBER_MOTOR);
//			double numberMotor = property != null ? new Double(property.getValue()).doubleValue() : 1.0;
//			Record recordPower = recordSet.get(measurements[4]); // 4=power [w]
//			property = record.getProperty(LiPoWatch.PROP_N_100_WATT);
...
//		measurement.setName(LiPoWatchDialog.A1_MODUS_NAMES[a1Modus].trim());
//		measurement.setUnit(LiPoWatchDialog.A1_MODUS_UNITS[a1Modus].trim());
//
//		measurement = this.getMeasurement(configKey, 12); // 12=A1
//		measurement.setName(LiPoWatchDialog.A2_MODUS_NAMES[a2Modus].trim());
//		measurement.setUnit(LiPoWatchDialog.A2_MODUS_UNITS[a2Modus].trim());
//		
//		measurement = this.getMeasurement(configKey, 13); // 13=A1
//		measurement.setName(LiPoWatchDialog.A3_MODUS_NAMES[a3Modus].trim());
//		measurement.setUnit(LiPoWatchDialog.A3_MODUS_UNITS[a3Modus].trim());
	}
}
