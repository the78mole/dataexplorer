...
cp -r iChargerUSB.kext /System/Library/Extensions/
...
echo open terminal enter "sudo kextutil -t /System/Library/Extensions/iChargerUSB.kext" before USB cable connected. This will load none signed kext
...
echo Alternative use Kext Utility to copy iChargerUSB.kext os search the internet for installing 3rd party kext
