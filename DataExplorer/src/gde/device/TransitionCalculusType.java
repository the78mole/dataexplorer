 ...
 *       &lt;attribute name="referenceGroupIdDivisor" use="required" type="{http://www.w3.org/2001/XMLSchema}int" />
 *       &lt;attribute name="divisorLeveling" use="required" type="{}leveling_types" />
...
public class TransitionCalculusType {
    ...
    @XmlAttribute(required = true)
    protected int referenceGroupIdDivisor;
    @XmlAttribute(required = true)
     ...
     * 
     */
    public int getReferenceGroupIdDivisor() {
     ...
     * 
     */
    public void setReferenceGroupIdDivisor(int value) {
