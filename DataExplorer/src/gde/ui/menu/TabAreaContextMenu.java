	...
	public void createMenu(Menu popupMenu, int type) {
		...
		if (!isCreated) {
			if (type == TYPE_GRAPHICS) { // -1 as index mean initialization phase
				...
				this.displayGraphicsCommentItem.setText(Messages.getString(MessageIds.OSDE_MSGT0042));
			...
			this.copyTabItem.setText(Messages.getString(MessageIds.OSDE_MSGT0026));
			...
			if (type == TYPE_GRAPHICS || type == TYPE_COMPARE) {
				...
				this.copyPrintImageItem.setText(Messages.getString(MessageIds.OSDE_MSGT0027));
