 ...
 */
public final class SettlementRecord extends TrailRecord {
	private final static String	$CLASS_NAME				= SettlementRecord.class.getName();
	 ...
	 */
	public SettlementRecord(int newOrdinal, SettlementType settlementType, TrailRecordSet parent, int initialCapacity) {
