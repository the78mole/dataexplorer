 ...
 * <ul>
 * <li>{@code ImmutableMap} replaced by {@code Map}.
 * This map should be created like this:
 * {@code Collections.unmodifiableMap(new LinkedHashMap<String, String>(realMap));}
 * <li>{@code LongAddable} replaced by {@code LongAdder}
 * </ul>
 *
