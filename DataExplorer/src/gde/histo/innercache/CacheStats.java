...
public final class CacheStats {
  ...
  public CacheStats(
	...
	@Override
	public int hashCode() {
		String values = String.format("%d,%d,%d,%d,%d,%d", hitCount, missCount, loadSuccessCount, loadExceptionCount, totalLoadTime, evictionCount);
  ...
  public boolean equals(@Nullable Object object) {
	...
	public String toString() {
		return String.format("hitCount=%d missCount=%d loadSuccessCount=%d loadExceptionCount=%d totalLoadTime=% evictionCount=%d", //
